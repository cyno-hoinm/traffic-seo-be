...
Deposit.belongsTo(Transaction, { foreignKey: 'orderId', as: 'transaction' ,onDelete: 'SET NULL'});
Transaction.hasOne(Deposit, { foreignKey: 'referenceId', as: 'deposit',onDelete: 'SET NULL'});
// Export models
export {
  Role,
  Permission,
